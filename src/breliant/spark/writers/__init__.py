...
```python
from breliant.spark.writers import OutputMode
...
from breliant.models import Field, nested_enum
...
class OutputMode:
    ...
    ```python
    from breliant.spark.writers import OutputMode, Writer
    ...
    class BATCH(str, Enum):
        ...
        Available modes:
        ---------------
        - append: Append the contents of the DataFrame to the output table (default in breliant)
