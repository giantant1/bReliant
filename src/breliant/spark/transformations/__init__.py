...
[reference/concepts/spark/transformations](../../../reference/spark/transformations.md) section of the breliant
documentation.
...
from breliant.models import Field, ListOfColumns, model_validator
from breliant.spark import Column, DataFrame, SparkStep
from breliant.spark.utils import SparkDatatype, get_column_name
...
class Transformation(SparkStep, ABC):
    ...
    ```python
    from breliant.steps.transformations import Transformation
    from pyspark.sql import functions as f
...
class ColumnsTransformation(Transformation, ABC):
    ...
    -------------------------------------
    [ColumnConfig]: ./index.md#breliant.spark.transformations.ColumnsTransformation.ColumnConfig
    [SparkDatatype]: ../utils.md#breliant.spark.utils.SparkDatatype
    ...
    ```python
    from pyspark.sql import functions as f
    from breliant.steps.transformations import ColumnsTransformation
    ...
    class ColumnConfig:
        """
        breliant ColumnsTransformation specific Config
...
class ColumnsTransformationWithTarget(ColumnsTransformation, ABC):
    ...
    from breliant.steps.transformations import (
        ColumnsTransformationWithTarget,
    )
