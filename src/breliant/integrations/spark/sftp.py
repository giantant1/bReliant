...
Refer to breliant.spark.writers.buffer for more details on the BufferWriter interface.
...
from breliant.spark.writers.buffer import (
    BufferWriter,
...
class SendCsvToSftp(PandasCsvBufferWriter, SFTPWriter):
    ...
    -------
    ```python
    from breliant.spark.writers import SendCsvToSftp
    ...
    def set_up_buffer_writer(self) -> "SendCsvToSftp":
        ...
        self.buffer_writer = PandasCsvBufferWriter(**self.get_options(options_type="breliant_pandas_buffer_writer"))
        return self
...
class SendJsonToSftp(PandasJsonBufferWriter, SFTPWriter):
    ...
    -------
    ```python
    from breliant.spark.writers import SendJsonToSftp
