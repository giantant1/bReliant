...
Version 0.11 is breliant's 5th release since getting Open Sourced.
...
* **Full Changelog**:
    <https://github.com/Nike-Inc/breliant/compare/breliant-v0.10.6...breliant-v0.11.0>

### Bugfixes

!!! bug "bugfix - PR [#TBD](https://github.com/Nike-Inc/breliant/pull/TBD), related issue [#226](https://github.com/Nike-Inc/breliant/issues/226)"
...
!!! feature "enhancement - PR [#239](https://github.com/Nike-Inc/breliant/pull/239)"
    #### *Core > Models*: New NestedEnum utility for case-insensitive nested enums
    
    Added a new `NestedEnum` utility to `breliant.models` enabling clean, case-insensitive
...
!!! bug "bugfix - PR [#237](https://github.com/Nike-Inc/breliant/pull/237), related issue [#236](https://github.com/Nike-Inc/breliant/issues/236)"
