"""
The Context module is a part of the breliant framework and is primarily used for managing the environment configuration
...
[reference/concepts/context](../reference/concepts/context.md) section of the breliant documentation.
"""
...
class Context(Mapping):
    """
    The Context class is a key component of the breliant framework, designed to manage configuration data and shared
    ...
    def _recursive_merge(cls, target_context: Context, merge_context: Context) -> Context:
        ...
        target_context: Context
            breliant Context to merge into
        merge_context: Context
            breliant Context that is being merged
