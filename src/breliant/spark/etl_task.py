...
from breliant.models import Field, InstanceOf, conlist
...
class EtlTask(Step):
    ...
    source : breliant.steps.readers.Reader
        Source to read from [extract]
    transformations : list[breliant.steps.transformations.Transformation]
        Series of transformations [transform]. The order of the transformations is important!
    target : breliant.steps.writers.Writer
    ...
    -------
    ```python
    from breliant.tasks import EtlTask

    from breliant.steps.readers import CsvReader
    from breliant.steps.transformations.repartition import Repartition
    from breliant.steps.writers import CsvWriter
