...
from breliant.logger import LoggingFactory, MaskedString
from breliant.models import Field, SecretStr
...
class OktaAccessToken(Okta):
    ...
    def __init__(self, **kwargs):  # type: ignore[no-untyped-def]
        _logger = LoggingFactory.get_logger(name=self.__class__.__name__, inherit_from_breliant=True)
