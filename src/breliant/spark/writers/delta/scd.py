...
breliant is a powerful data processing framework that provides advanced capabilities for working with Delta tables in Apache Spark.
...
By using breliant, you can benefit from its efficient merge logic, support for SCD Type 2 and SCD Type 1 attributes,
...
from breliant.spark import Column, DataFrame, SparkSession
