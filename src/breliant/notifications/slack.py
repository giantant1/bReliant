...
from breliant.models import ConfigDict, Field
from breliant.notifications import NotificationSeverity
from breliant.steps.http import HttpPostStep
...
class SlackNotificationWithSeverity(SlackNotification):
    ...
    Example:
        from breliant.steps.integrations.notifications import NotificationSeverity
