...
from breliant.models import ExtraParamsMixin, Field
from breliant.spark import DataFrameReader, DataStreamReader
...
class KafkaReader(Reader, ExtraParamsMixin):
    ...
    * Any extra kafka options can also be passed as key-word arguments; these will be merged with the `params` parameter
    ...
    -------
    ```python
    from breliant.spark.readers.kafka import KafkaReader
