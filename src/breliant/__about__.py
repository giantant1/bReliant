...
breliant is a Python framework for building type-safe and efficient data pipelines, particularly useful for
...
With its simple and straightforward API, breliant makes it easy for developers to build and manage data pipelines,
enhancing productivity and code maintainability.
"""

LICENSE_INFO = "Licensed as Apache 2.0"
SOURCE = "https://github.com/Nike-Inc/breliant"
...
__about__ = f"""breliant - v{__version__}
...
def _about() -> str:  # pragma: no cover
    """Return the breliant logo and version/about information as a string
