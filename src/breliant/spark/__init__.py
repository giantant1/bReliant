...
from breliant.models import model_validator
...
def current_timestamp_utc(spark):
    warnings.warn(
        message=(
            "The current_timestamp_utc function has been moved to the breliant.spark.functions module."
            "Import it from there instead. Current import path will be deprecated in the future."
        ),
        category=DeprecationWarning,
        stacklevel=2,
    )
    from breliant.spark.functions import current_timestamp_utc as _current_timestamp_utc
