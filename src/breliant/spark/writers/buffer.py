...
from breliant.models import ExtraParamsMixin, Field, constr
...
class PandasCsvBufferWriter(BufferWriter, ExtraParamsMixin):
    ...
    Pyspark vs Pandas
    -----------------
    The following table shows the mapping between Pyspark, Pandas, and breliant properties. Note that the default values
    ...
    | PySpark Property | Default PySpark | Pandas Property | Default Pandas | breliant Property | Default breliant | Notes |
    |------------------|-----------------|-----------------|----------------|-------------------|------------------|-------|
    ...
    -------------------------
    - dateFormat -> Pandas implements Timestamp, not just Date. Hence, breliant sets the default to the python
        equivalent of PySpark's default.
    - compression -> Spark does not compress by default, hence breliant does not compress by default. Compression can
        be provided though.
    ...
    header : bool, optional, default=True
        ...
        dataframe are used as the header. breliant sets this default to True to match Pandas' default.
    ...
    quoteAll : bool, optional, default=False
        A flag indicating whether all values should always be enclosed in quotes in a field. breliant sets the default
    ...
    escape : str, optional, default=\\
        String of length 1. Character used to escape sep and quotechar when appropriate. breliant sets this default to
    ...
    timestampFormat : str, optional, default=yyyy-MM-dd'T'HH:mm:ss[.SSS][XXX]
        Sets the string that indicates a date format for datetime objects. breliant sets this default to a close
    ...
    compression : Optional[Literal["infer", "gzip", "bz2", "zip", "xz", "zstd", "tar"]], optional, default=None
        ...
        this default to 'infer', breliant sets this default to 'None' leaving the data uncompressed by default. Can be
    ...
    header: bool = Field(
        ...
        "as used in the dataframe are used as the header. breliant sets this default to True to match Pandas' default.",
    )
    ...
    quoteAll: bool = Field(
        default=False,
        description="A flag indicating whether all values should always be enclosed in quotes in a field. breliant set "
    ...
    escape: constr(max_length=1) = Field(
        default="\\",
        description="String of length 1. Character used to escape sep and quotechar when appropriate. breliant sets "
    ...
    timestampFormat: str = Field(
        ...
        description="Sets the string that indicates a date format for datetime objects. breliant sets this default to "
    ...
    compression: Optional[PandasCompressionOptions] = Field(
        ...
        "Note: Pandas sets this default to 'infer', breliant sets this default to 'None' leaving the data uncompressed "
    ...
    emptyValue: Optional[str] = Field(
        default="",
        description="The string to use for missing values. breliant sets this default to an empty string.",
    )
    ...
    index: bool = Field(
        default=False,
        description="Toggles whether to write row names (index). Default False in breliant - pandas default is True.",
    )
    ...
    def get_options(self, options_type: str = "csv") -> dict:
        ...
        elif options_type == "breliant_pandas_buffer_writer":
...
class PandasJsonBufferWriter(BufferWriter, ExtraParamsMixin):
    ...
    compression : Optional[Literal["gzip"]]
        ...
        breliant sets this default to 'None' leaving the data uncompressed. Can be set to gzip' optionally.
        Other compression options are currently not supported by breliant for JSON output.
    ...
    - `date_format`: This parameter determines the format of date strings. It accepts two options: 'epoch' and 'iso'.
        ...
        However, in breliant, the default is set to 'iso' irrespective of the `orient` parameter.
    ...
    compression: Optional[Literal["gzip"]] = Field(
        default=None,
        description="A string representing the compression to use for on-the-fly compression of the output data."
        "breliant sets this default to 'None' leaving the data uncompressed by default. "
