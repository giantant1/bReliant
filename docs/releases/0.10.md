...
Version 0.10 is breliant's 4th release since getting Open Sourced.

This version brings several important features, security improvements, and bug fixes across different modules of breliant. The overall API remains unchanged.

## New Contributors

Big shout out to all contributors and a heartfelt welcome to our new contributors:

* @nogitting made their first contribution in <https://github.com/Nike-Inc/breliant/pull/154>
* @zarembat made their first contribution in <https://github.com/Nike-Inc/breliant/pull/163>
* @brunodd made their first contribution in <https://github.com/Nike-Inc/breliant/pull/180>

## Migrating from v0.9

For users currently using v0.9, consider the following:

* Consider switching to the new `SecretStr` and `SecretBytes` classes for handling secret strings and bytes with enhanced security. These classes are compatible with Pydantic's SecretStr and SecretBytes and allow seamless integration with existing code. To use, replace `from pydantic import SecretStr, SecretBytes` with `from breliant.models import SecretStr, SecretBytes` to use the enhanced secret handling. This is especially useful if you find yourself needing to format secret strings or bytes (i.e. concatenation, f-strings, etc.) while maintaining security.
...
* **Full Changelog**:
    <https://github.com/Nike-Inc/breliant/compare/breliant-v0.10.5...breliant-v0.10.6>

!!! feat "feature - PR [#216](https://github.com/Nike-Inc/breliant/pull/216)"
    #### *Snowflake*: Key-pair authentication

    Added possibility to authorize to Snowflake using Key-pair authentication.

    <small> by @Ttommeke </small>
...
* **Full Changelog**:
    <https://github.com/Nike-Inc/breliant/compare/breliant-v0.10.4...breliant-v0.10.5>

!!! bug "bugfix - PR [#210](https://github.com/Nike-Inc/breliant/pull/210)"
...
* **Full Changelog**:
    <https://github.com/Nike-Inc/breliant/compare/breliant-v0.10.3...breliant-v0.10.4>

!!! bug "bugfix - PR [#203](https://github.com/Nike-Inc/breliant/pull/203), related issue #203"
...
!!! bug "bugfix - PR [#189](https://github.com/Nike-Inc/breliant/pull/189), related issue #189"
...
* **Full Changelog**:
    <https://github.com/Nike-Inc/breliant/compare/breliant-v0.10.2...breliant-v0.10.3>

!!! bug "bugfix - PR [#194](https://github.com/Nike-Inc/breliant/pull/194), related issue #175"
...
!!! bug "bugfix - PR [#197](https://github.com/Nike-Inc/breliant/pull/197), related issue #186"
...
!!! bug "bugfix - PR [#198](https://github.com/Nike-Inc/breliant/pull/198), related issue #195"
...
!!! bug "bugfix - PR [#194](https://github.com/Nike-Inc/breliant/pull/194), related issue #200"
...
* **Full Changelog**:
    <https://github.com/Nike-Inc/breliant/compare/breliant-v0.10.1...breliant-v0.10.2>

!!! bug "bugfix - PR [#177](https://github.com/Nike-Inc/breliant/pull/177), related issue #178"
...
!!! bug "bugfix - PR [#179](https://github.com/Nike-Inc/breliant/pull/179)"
...
!!! bug "bugfix - PR [#180](https://github.com/Nike-Inc/breliant/pull/180)"
...
* **Full Changelog**:
    <https://github.com/Nike-Inc/breliant/compare/breliant-v0.10.0...breliant-v0.10.1>

!!! abstract "refactor - PR [#174](https://github.com/Nike-Inc/breliant/pull/174)"
    #### *Core*: Clarify experimental nature of `SecretStr.__format__`

    <small> by @dannymeijer </small>  

!!! bug "bugfix - PR [#174](https://github.com/Nike-Inc/breliant/pull/174)"
...
* **Full Changelog**:  
    <https://github.com/Nike-Inc/breliant/compare/breliant-v0.9.1...breliant-v0.10.0>

### Features and Enhancements

The following new features are included with 0.10:

!!! abstract "feature - PR [#164](https://github.com/Nike-Inc/breliant/pull/164)"
    #### *Core*: Added breliant specific `SecretStr` and `SecretBytes` classes

    Allows formatting secret strings and bytes with enhanced security.  
    To use: replace `from pydantic import SecretStr, SecretBytes` with `from breliant.models import SecretStr, SecretBytes` in your import statement.
...
!!! abstract "feature - PR [#150](https://github.com/Nike-Inc/breliant/pull/150)"
...
!!! abstract "feature - PR [#161](https://github.com/Nike-Inc/breliant/pull/161), related issues: #87, #148"
...
!!! abstract "feature - PR [#168](https://github.com/Nike-Inc/breliant/pull/168)"
...
!!! abstract "feature - PR [#163](https://github.com/Nike-Inc/breliant/pull/163)"
...
!!! abstract "feature - PR [#158](https://github.com/Nike-Inc/breliant/pull/158) & [#170](https://github.com/Nike-Inc/breliant/pull/170), related issue: #157"
...
!!! abstract "feature - PR [#143](https://github.com/Nike-Inc/breliant/pull/143), related issue: #75"
    ...
    * Added `DownloadFileStep` class in a new module `breliant.steps.download_file`
    * Added `FileWriteMode` enum with supported write modes: `OVERWRITE`, `APPEND`, `IGNORE`, `EXCLUSIVE`, `BACKUP`
    
    Also made available as a spark `Transformation` in `DownloadFileFromUrlTransformation` in a new module `breliant.spark.transformations.download_files`
...
!!! abstract "refactor - PR [#168](https://github.com/Nike-Inc/breliant/pull/168)"
...
!!! abstract "refactor - PR [#142](https://github.com/Nike-Inc/breliant/pull/142)"
...
!!! bug "bugfix - PR [#160](https://github.com/Nike-Inc/breliant/pull/160)"
...
!!! bug "bugfix - PR [#168](https://github.com/Nike-Inc/breliant/pull/168), related issue: #167"
...
!!! bug "bugfix - PR [#155](https://github.com/Nike-Inc/breliant/pull/155), related issue: #149"
...
!!! bug "bugfix - PR [#154](https://github.com/Nike-Inc/breliant/pull/154), related issue: #153"
...
!!! bug "bugfix - PR [#142](https://github.com/Nike-Inc/breliant/pull/142)"
...
!!! bug "bugfix - PR [#168](https://github.com/Nike-Inc/breliant/pull/168)"
